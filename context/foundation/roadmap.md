...
- **F-06: (foundation) The floor the earlier elements established is enforced on every change rather than documented — including the currently unwired typecheck gate and a resolved placement for the policy-test gate.** — Archived 2026-09-14 → `context/archive/2026-09-14-testing-quality-gates/`. Lesson: —.

...
|-------|------------|------|-------|----------------|------------|--------|----------------|
| [MAT-5](https://linear.app/mateusz-yt-niche-advisor/issue/MAT-5/f-01-domkniecie-must-have-logowania-google-oauth) | F-01 | Foundation | Domknięcie must-have logowania (Google OAuth) | Todo | — | `roadmap-foundation`, `status-ready` | [#1](https://github.com/Keitar6/10xDevs-YT-Niche-Adviser/issues/1) |
| [MAT-6](https://linear.app/mateusz-yt-niche-advisor/issue/MAT-6/f-02-model-danych-profilu-kanalu-rls-per-owner) | F-02 | Foundation | Model danych profilu kanału (RLS per-owner) | Todo | — | `roadmap-foundation`, `status-ready` | [#2](https://github.com/Keitar6/10xDevs-YT-Niche-Adviser/issues/2) |
